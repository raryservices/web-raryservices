...
export function ServiceCard({ icon, title, className }: IServiceCardProps) {
  return (
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <section className="flex items-center justify-center relative h-[336px] overflow-hidden">
        ...
        <div className="flex h-full flex-col items-center justify-center gap-3.5 px-7 md:p-0 z-20 text-center md:text-start">
      ...
      <section className="flex flex-col mt-12 w-full">
        ...
        <Text className="text-[22px] text-white w-fit h-fit mx-12 p-[12px_14px] bg-[#262626] rounded-lg mb-24">
